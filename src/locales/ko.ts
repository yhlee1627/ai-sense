const ko = {
    home: {
      title: 'AI-Sense',
      description: 'AI와 관련된 윤리적 딜레마 상황에서, 여러분은 어떤 선택을 하실지 궁금합니다.\n설문에 앞서 성별과 나이를 입력해 주세요!',
      startButton: '설문 시작하기',
      genderLabel: '성별',
      ageLabel: '나이',
      languageLabel: '🌐',
    ...
    questions: [
      {
        ...
        detail2: '자율주행자동차가 신호를 지킨 보행자 한 명을 보호하기 위해, 다수를 향해 돌진하는 장면입니다.\n차량은 도덕적 원칙을 따르며, 피해가 크더라도 무고한 희생을 피하려 합니다.'
      },
      {
        title: 'AI 얼굴인식 감시카메라',
      ...
      },
      {
        ...
        option2: '사람의 목숨과 관련되기 때문에, 적군이 맞는지 확실해지기 전까지는 공격하지 않도록 인간이 최종 결정을 내려야 한다.',
        option1_type: '공리주의',
        option2_type: '의무론',
      ...
      },
      {
        ...
        detail2: '피고인은 AI 판사의 판결에 억울함을 호소하며 혼란스러워하는 장면입니다.\nAI 알고리즘에 반영된 편향이 고쳐지지 않고 판결되기때문에 오히려 공정하지 않을 수 있다는 입장을 담고 있습니다.'
      },
      {
        title: 'AI 진단 시스템',
